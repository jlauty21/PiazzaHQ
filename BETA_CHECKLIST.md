...
- **On promotion to stable, this file gets wiped back to this same clean
  ...
  happen to line up with completely different items in the new file.

---

## Currently open (— beta cycle, beta.1 so far)

*(nothing yet this cycle — 1.80.0 just promoted to stable; the beta.1
through beta.3 history that led up to it lives in CHANGELOG.md and
HANDOFF.md, not here)*
