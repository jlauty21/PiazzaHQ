/* Vendored from go2rtc v1.9.14 (github.com/AlexxIT/go2rtc, MIT) —
   www/video-rtc.js + www/video-stream.js, concatenated, 'export'/'import'
   stripped, wrapped in an IIFE so only <video-stream> is registered.
   Do not edit by hand; re-vendor from the pinned tag on a go2rtc bump. */
(function () {
'use strict';
/**
